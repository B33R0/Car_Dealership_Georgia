...
for page in range(1, 8):
    ...
    for car in cars_item:
        ...
        price_gel_usd = price_item.div.text
        feat = features.split('\n')
        price_splt = price_gel_usd.split('\n')

        file_obj.writerow([name, feat[1], feat[2], feat[3], feat[4], price_splt[2] + '₾', price_splt[1] + '$'])
